...
import 'package:clipshare/features/settings/providers/app_paths/app_paths_provider.dart';
import 'package:clipshare/features/settings/providers/preference/preference_settings_provider.dart';
import 'package:clipshare/features/settings/providers/quick/quick_settings_provider.dart';
...
Future<void> _initWindowsManager(Ref ref) async {
  ...
  await ref.read(windowControlProvider.notifier).initWindows();
