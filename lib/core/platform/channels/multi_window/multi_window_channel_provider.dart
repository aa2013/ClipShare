...
import 'package:clipshare/core/extensions/paste_window_result_extension.dart';
...
import 'multi_window_method.dart';
import 'window_type.dart';

part 'multi_window_channel_provider.g.dart';

part 'multi_window_channel_method_call.dart';

@Riverpod(keepAlive: true)
class MultiWindowChannelNotifier extends _$MultiWindowChannelNotifier {
  static const tag = 'MultiWindowChannelNotifier';
  final _hideWindowIds = <int>{};
  WindowController? _historyWindow;
  WindowController? _onlineDevicesWindow;

  @override
  void build() {
    DesktopMultiWindow.setMethodHandler((MethodCall call, int fromWindowId) => _onMethodCall(this, ref, call, fromWindowId));
  }
  ...
  Future copy(int targetWindowId, int historyId) {
    if (!isDesktop) return Future(() => false);
    return DesktopMultiWindow.invokeMethod(
      targetWindowId,
  ...
  Future<void> updateConfig(
    ...
    var ids = <int>[];
    final historyWindow = _historyWindow;
    final onlineDevicesWindow = _onlineDevicesWindow;
