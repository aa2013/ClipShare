...
class _ThemeModeButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedBg = theme.colorScheme.primary.withValues(alpha: isDarkMode ? 0.22 : 0.12);
    final borderColor = selected ? theme.colorScheme.primary.withValues(alpha: isDarkMode ? 0.62 : 0.36) : theme.colorScheme.onSurface.withValues(alpha: 0.10);
