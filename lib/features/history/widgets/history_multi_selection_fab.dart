...
class HistoryMultiSelectionFabAction {
  final VoidCallback? onPressed;
  final String tooltip;
  final Widget child;

  const HistoryMultiSelectionFabAction({
...
/// 让不同列表只关心自身动作与滚动回调。
class HistoryMultiSelectionFab extends StatelessWidget {
  ...
  final List<HistoryMultiSelectionFabAction> actions;

  const HistoryMultiSelectionFab({
    super.key,
  ...
  FloatingActionButton _buildActionButton(HistoryMultiSelectionFabAction action) {
