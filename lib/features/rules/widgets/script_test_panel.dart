...
import 'package:clipshare/features/rules/widgets/rule_result_highlight.dart';
import 'package:clipshare/features/rules/widgets/script_compile_info_highlight.dart';
...
import 'package:clipshare/shared/widgets/dot.dart';
import 'package:flutter/material.dart';

import 'rule_log_line_highlight.dart';
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return RuleLogLineHighLight(log: outputs[index]);
        },
      ),
    );
  }
        ...
        Row(
          ...
          children: [
            TinySegmentedControl(
              ...
              backgroundColor: context.isDarkMode ? const Color(0xff2e3b42) : const Color(0xffdde1e3),
              onSelected: (index) {
                setState(() {
                  panelIndex = index;
