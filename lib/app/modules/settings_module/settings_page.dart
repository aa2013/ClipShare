                                  ...
                                  homeController
                                    ...
                                    Global.showDialog(
                                      ...
                                      TextEditDialog(
                                        ...
                                        verify: (str) {
                                          return (str.isEmpty && (appConfig.dhAesKey ?? '').isNotEmpty) || str
                                              .replaceAll('\\s+', '')
                                              .length >= 8;
                                        },
                      ...
                      SettingCardGroup(
                        ...
                        cardList: [
                          SettingCard(
                            ...
                            action: (v) {
                              final desc = AppHotKeyHandler
                                  .getByType(HotKeyType.historyWindow)
                                  ?.desc;
                          ...
                          SettingCard(
                            ...
                            action: (v) {
                              final desc = AppHotKeyHandler
                                  .getByType(HotKeyType.fileSender)
                                  ?.desc;
                              final dialog = HotKeyEditorDialog(
                          ...
                          SettingCard(
                            ...
                            action: (v) {
                              final desc = AppHotKeyHandler
                                  .getByType(HotKeyType.showMainWindows)
                                  ?.desc;
                              final dialog = HotKeyEditorDialog(
