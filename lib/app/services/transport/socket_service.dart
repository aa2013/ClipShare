...
class SocketService extends GetxService with ScreenOpenedObserver, DataSender {
  ...
  Future<void> connectForwardServer([bool startDiscovery = false]) {
    if (_disposed || !appConfig.enableForward || appConfig.forwardWay != ForwardWay.server || forwardServerHost == null || forwardServerPort == null) {
