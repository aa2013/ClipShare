...
class SecureSocketClient extends SocketClientBase<MessageData> {
  ...
  final Set<SocketClientMsgObserver<MessageData>> _observers = {};
  ...
  static SecureSocketClient empty = SecureSocketClient._private(
      ...
      if (isForwardMode && !_forwardReady) {
        ...
        if (_keyIsExchanged) {
          ...
          if (_onMessage != null) {
            ...
            _onMessage(
              this,
              (map as Map<dynamic, dynamic>).cast<String, dynamic>(),
            );
          }
        } else {
          //密钥未交换
  ...
  @override
  void register(SocketClientMsgObserver<MessageData> observer) {
    _observers.add(observer);
  }

  @override
  void unregister(SocketClientMsgObserver<MessageData> observer) {
