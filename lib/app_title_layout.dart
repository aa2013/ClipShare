    ...
    return Column(
      children: [
        Visibility(
          ...
          child: SizedBox(
            height: AppTitleBarLayout.windowsTitleBarHeight,
                      ...
                      children: [
                        Visibility(
                          ...
                          child: PlatformTitleButton(
                            ...
                            icon: MdiIcons.minus,
                            size: isWindows ? AppTitleBarLayout.windowsTitleBarHeight : 25,
                          ),
                        ),
                        //最小化与右边的间隔
                        if (isLinux)
