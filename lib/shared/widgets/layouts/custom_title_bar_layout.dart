...
import 'package:clipshare/shared/enums/multi_window_tag.dart';
...
class CustomTitleBarLayout extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isSmallScreen = media.size.width <= smallScreenWidth;
    Widget body;
    if ((isLandscape || !isSmallScreen) && isMobile) {
      body = Scaffold(
    ...
    return Column(
      children: [
        Visibility(
          visible: isDesktop && !Platform.isMacOS,
          child: SizedBox(
            height: CustomTitleBarLayout.windowsTitleBarHeight,
                      ...
                      children: [
                        Visibility(
                          ...
                          child: PlatformTitleButton(
                            ...
                            icon: MdiIcons.minus,
                            size: Platform.isWindows ? CustomTitleBarLayout.windowsTitleBarHeight : 25,
                          ),
                        ),
                        //最小化与右边的间隔
                        if (Platform.isLinux)
  ...
  Widget _buildPinWidget(
    ...
    return PlatformTitleButton(
      ...
      size: Platform.isWindows ? windowsTitleBarHeight : defaultTitleBarHeight,
    );
  }
}
