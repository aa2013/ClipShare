...
/// 当前平台的路径分隔符（与 core 层 platform_constants 解耦）。
String get dirSeparate => Platform.isWindows ? '\\' : '/';
...
extension StringExt on String {
  ...
  String get normalizePath {
    return replaceAll(RegExp(r'(/+|\\+)'), dirSeparate);
  }

  String get unixPath {
    return replaceAll(RegExp(r'(/+|\\+)'), unixDirSeparate);
  }
  ...
  void askOpenUrl(BuildContext context) {
    if (!hasUrl) return;
  ...
  String trimStr(String substring) {
    return trimStart(substring).trimEnd(substring);
  }
...
extension StringNilExt on String? {
  ...
  bool get isBlank => this == null || this!.trim() == '';
}
